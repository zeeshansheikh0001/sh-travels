  ...
  return (
    <main className="relative py-[100px] px-[5%] special-font">
      <section className="relative p-4 md:p-8 rounded-lg rounded-tl-3xl flex flex-col gap-10 items-center justify-center bg-gray-100 h-[300px] z-10">
        <p
          className="text-xl md:text-3xl font-bold text-litegrey w-full md:w-[75%] text-center relative z-10"
          data-aos="fade-down"
        >
        ...
        >
          <label htmlFor="" className="relative w-full md:w-[50%]">
            <input
              ...
              className="relative border-none outline-none bg-white rounded-lg py-3 pl-12 pr-4 w-full text-[15px] font-normal"
            />
            <IoMailOutline className="absolute text-litedark text-3xl top-2 left-2" />
          </label>
          <button className="bg-[#FF7D68] text-[15px] py-3 px-5 text-white font-medium rounded-lg">
            Subscribe
          </button>
        </div>
