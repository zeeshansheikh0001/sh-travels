  ...
  return (
    <main className="relative w-full flex flex-col md:flex-row items-center justify-between py-[80px] md:py-[100px] px-[5%] bg bg-right-top bg-no-repeat bg-contain">
      <section className="w-full md:w-[50%] flex flex-col items-center md:items-start justify-center md:justify-start gap-3">
        <p
          className="text-[14px] text-green font-bold special-font"
          data-aos="fade-down"
        >
          BEST DESTINATIONS AROUND THE WORLD
        </p>
        <h1
          className="text-4xl md:text-5xl xl:text-6xl text-blue font-extrabold w-full lg:w-[80%] text-center md:text-left"
          data-aos="fade-down"
        >
          Travel,
        ...
        <p
          className="text-[14px] text-litegrey font-bold w-full lg:w-[80%] xl:w-[65%] text-center md:text-justify special-font"
          data-aos="fade-up"
        >
          Embark on a journey of a lifetime with SH Travels, where every
          adventure is crafted with passion and personalized just for you. Our
          commitment is to turn your travel dreams into reality, creating
          memories that last a lifetime.
        </p>

        <div
          className="flex items-center gap-4 special-font"
          data-aos="fade-up"
        >
          <a
            href="#category"
            className="py-3 px-5 rounded-md bg-orange text-white text-[14px] font-bold flex items-center"
          >
            Find Out More
          </a>
